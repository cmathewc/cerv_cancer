...
type1_rpath = os.path.join('complete', 'Type_1')
type2_rpath = os.path.join('complete', 'Type_2')
type3_rpath = os.path.join('complete', 'Type_3')
...
test_path = os.path.join(os.getcwd(), 'Data', 'test_small')

ofile = open('img_key_test.csv',"w")
